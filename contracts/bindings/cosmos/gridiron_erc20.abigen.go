...
// GridironERC20ABI is the input ABI used to generate the binding from.
// Deprecated: Use GridironERC20MetaData.ABI instead.
var GridironERC20ABI = GridironERC20MetaData.ABI

// GridironERC20Bin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use GridironERC20MetaData.Bin instead.
...
func DeployGridironERC20(auth *bind.TransactOpts, backend bind.ContractBackend, _denom string) (common.Address, *types.Transaction, *GridironERC20, error) {
	parsed, err := GridironERC20MetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(GridironERC20Bin), backend, _denom)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &GridironERC20{GridironERC20Caller: GridironERC20Caller{contract: contract}, GridironERC20Transactor: GridironERC20Transactor{contract: contract}, GridironERC20Filterer: GridironERC20Filterer{contract: contract}}, nil
}
...
// GridironERC20Session is an auto generated Go binding around an Ethereum contract,
...
// GridironERC20CallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// GridironERC20TransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewGridironERC20(address common.Address, backend bind.ContractBackend) (*GridironERC20, error) {
	contract, err := bindGridironERC20(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &GridironERC20{GridironERC20Caller: GridironERC20Caller{contract: contract}, GridironERC20Transactor: GridironERC20Transactor{contract: contract}, GridironERC20Filterer: GridironERC20Filterer{contract: contract}}, nil
}
...
func NewGridironERC20Caller(address common.Address, caller bind.ContractCaller) (*GridironERC20Caller, error) {
	contract, err := bindGridironERC20(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &GridironERC20Caller{contract: contract}, nil
}
...
func NewGridironERC20Transactor(address common.Address, transactor bind.ContractTransactor) (*GridironERC20Transactor, error) {
	contract, err := bindGridironERC20(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &GridironERC20Transactor{contract: contract}, nil
}
...
func NewGridironERC20Filterer(address common.Address, filterer bind.ContractFilterer) (*GridironERC20Filterer, error) {
	contract, err := bindGridironERC20(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &GridironERC20Filterer{contract: contract}, nil
}

// bindGridironERC20 binds a generic wrapper to an already deployed contract.
func bindGridironERC20(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := GridironERC20MetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
func (_GridironERC20 *GridironERC20Raw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _GridironERC20.Contract.GridironERC20Caller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_GridironERC20 *GridironERC20Raw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _GridironERC20.Contract.GridironERC20Transactor.contract.Transfer(opts)
}
...
func (_GridironERC20 *GridironERC20Raw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _GridironERC20.Contract.GridironERC20Transactor.contract.Transact(opts, method, params...)
}
...
func (_GridironERC20 *GridironERC20CallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _GridironERC20.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_GridironERC20 *GridironERC20TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _GridironERC20.Contract.contract.Transfer(opts)
}
...
func (_GridironERC20 *GridironERC20TransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _GridironERC20.Contract.contract.Transact(opts, method, params...)
}
...
func (_GridironERC20 *GridironERC20Caller) DOMAINSEPARATOR(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "DOMAIN_SEPARATOR")
...
func (_GridironERC20 *GridironERC20Session) DOMAINSEPARATOR() ([32]byte, error) {
	return _GridironERC20.Contract.DOMAINSEPARATOR(&_GridironERC20.CallOpts)
}
...
func (_GridironERC20 *GridironERC20Caller) Allowance(opts *bind.CallOpts, owner common.Address, spender common.Address) (*big.Int, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "allowance", owner, spender)
...
func (_GridironERC20 *GridironERC20Session) Allowance(owner common.Address, spender common.Address) (*big.Int, error) {
	return _GridironERC20.Contract.Allowance(&_GridironERC20.CallOpts, owner, spender)
}
...
func (_GridironERC20 *GridironERC20Caller) BalanceOf(opts *bind.CallOpts, user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "balanceOf", user)
...
func (_GridironERC20 *GridironERC20Session) BalanceOf(user common.Address) (*big.Int, error) {
	return _GridironERC20.Contract.BalanceOf(&_GridironERC20.CallOpts, user)
}
...
func (_GridironERC20 *GridironERC20Caller) Decimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "decimals")
...
func (_GridironERC20 *GridironERC20Session) Decimals() (uint8, error) {
	return _GridironERC20.Contract.Decimals(&_GridironERC20.CallOpts)
}
...
func (_GridironERC20 *GridironERC20Caller) Denom(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "denom")
...
func (_GridironERC20 *GridironERC20Session) Denom() (string, error) {
	return _GridironERC20.Contract.Denom(&_GridironERC20.CallOpts)
}
...
func (_GridironERC20 *GridironERC20Caller) Name(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "name")
...
func (_GridironERC20 *GridironERC20Session) Name() (string, error) {
	return _GridironERC20.Contract.Name(&_GridironERC20.CallOpts)
}
...
func (_GridironERC20 *GridironERC20Caller) Nonces(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "nonces", arg0)
...
func (_GridironERC20 *GridironERC20Session) Nonces(arg0 common.Address) (*big.Int, error) {
	return _GridironERC20.Contract.Nonces(&_GridironERC20.CallOpts, arg0)
}
...
func (_GridironERC20 *GridironERC20Caller) Symbol(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "symbol")
...
func (_GridironERC20 *GridironERC20Session) Symbol() (string, error) {
	return _GridironERC20.Contract.Symbol(&_GridironERC20.CallOpts)
}
...
func (_GridironERC20 *GridironERC20Caller) TotalSupply(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _GridironERC20.contract.Call(opts, &out, "totalSupply")
...
func (_GridironERC20 *GridironERC20Session) TotalSupply() (*big.Int, error) {
	return _GridironERC20.Contract.TotalSupply(&_GridironERC20.CallOpts)
}
...
func (_GridironERC20 *GridironERC20Transactor) Approve(opts *bind.TransactOpts, spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _GridironERC20.contract.Transact(opts, "approve", spender, amount)
}
...
func (_GridironERC20 *GridironERC20Session) Approve(spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _GridironERC20.Contract.Approve(&_GridironERC20.TransactOpts, spender, amount)
}
...
func (_GridironERC20 *GridironERC20Transactor) Permit(opts *bind.TransactOpts, owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _GridironERC20.contract.Transact(opts, "permit", owner, spender, value, deadline, v, r, s)
}
...
func (_GridironERC20 *GridironERC20Session) Permit(owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _GridironERC20.Contract.Permit(&_GridironERC20.TransactOpts, owner, spender, value, deadline, v, r, s)
}
...
func (_GridironERC20 *GridironERC20Transactor) Transfer(opts *bind.TransactOpts, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _GridironERC20.contract.Transact(opts, "transfer", to, amount)
}
...
func (_GridironERC20 *GridironERC20Session) Transfer(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _GridironERC20.Contract.Transfer(&_GridironERC20.TransactOpts, to, amount)
}
...
func (_GridironERC20 *GridironERC20Transactor) TransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _GridironERC20.contract.Transact(opts, "transferFrom", from, to, amount)
}
...
func (_GridironERC20 *GridironERC20Session) TransferFrom(from common.Address, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _GridironERC20.Contract.TransferFrom(&_GridironERC20.TransactOpts, from, to, amount)
}
...
func (it *GridironERC20ApprovalIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GridironERC20Approval)
...
func (it *GridironERC20ApprovalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GridironERC20ApprovalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_GridironERC20 *GridironERC20Filterer) FilterApproval(opts *bind.FilterOpts, owner []common.Address, spender []common.Address) (*GridironERC20ApprovalIterator, error) {
	...
	logs, sub, err := _GridironERC20.contract.FilterLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return &GridironERC20ApprovalIterator{contract: _GridironERC20.contract, event: "Approval", logs: logs, sub: sub}, nil
}
...
func (_GridironERC20 *GridironERC20Filterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *GridironERC20Approval, owner []common.Address, spender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _GridironERC20.contract.WatchLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(GridironERC20Approval)
				if err := _GridironERC20.contract.UnpackLog(event, "Approval", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *GridironERC20TransferIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GridironERC20Transfer)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *GridironERC20TransferIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GridironERC20TransferIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_GridironERC20 *GridironERC20Filterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*GridironERC20TransferIterator, error) {
	...
	logs, sub, err := _GridironERC20.contract.FilterLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &GridironERC20TransferIterator{contract: _GridironERC20.contract, event: "Transfer", logs: logs, sub: sub}, nil
}
...
func (_GridironERC20 *GridironERC20Filterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *GridironERC20Transfer, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _GridironERC20.contract.WatchLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(GridironERC20Transfer)
				if err := _GridironERC20.contract.UnpackLog(event, "Transfer", log); err != nil {
					return err
				}
				event.Raw = log
