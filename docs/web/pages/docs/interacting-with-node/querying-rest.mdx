...
# Interacting With Gridiron Ethereum via REST

Gridiron Ethereum extends the base functionality of the Cosmos-SDK for querying via REST.
...
Gridiron Ethereum supports the Swagger API, which is a specification for describing RESTful APIs.
...
The above link will point towards the Cosmos Hub. To point towards your Gridiron Ethereum Endpoint and 
