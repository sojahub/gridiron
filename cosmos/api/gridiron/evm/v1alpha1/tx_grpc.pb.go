...
const (
	MsgService_EthTransaction_FullMethodName = "/gridiron.evm.v1alpha1.MsgService/EthTransaction"
	MsgService_UpdateParams_FullMethodName   = "/gridiron.evm.v1alpha1.MsgService/UpdateParams"
)
