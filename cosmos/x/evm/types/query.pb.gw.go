...
var (
	pattern_QueryService_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"gridiron", "evm", "v1alpha1", "params"}, "", runtime.AssumeColonVerbOpt(false)))
)
