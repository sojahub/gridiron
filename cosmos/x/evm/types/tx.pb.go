...
func init() {
	proto.RegisterType((*EthTransactionRequest)(nil), "gridiron.evm.v1alpha1.EthTransactionRequest")
	proto.RegisterType((*EthTransactionResponse)(nil), "gridiron.evm.v1alpha1.EthTransactionResponse")
	proto.RegisterType((*UpdateParamsRequest)(nil), "gridiron.evm.v1alpha1.UpdateParamsRequest")
	proto.RegisterType((*UpdateParamsResponse)(nil), "gridiron.evm.v1alpha1.UpdateParamsResponse")
}

func init() { proto.RegisterFile("gridiron/evm/v1alpha1/tx.proto", fileDescriptor_d8b33d2a2c64400f) }
...
func (c *msgServiceClient) EthTransaction(ctx context.Context, in *EthTransactionRequest, opts ...grpc.CallOption) (*EthTransactionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.evm.v1alpha1.MsgService/EthTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) UpdateParams(ctx context.Context, in *UpdateParamsRequest, opts ...grpc.CallOption) (*UpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.evm.v1alpha1.MsgService/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgService_EthTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.evm.v1alpha1.MsgService/EthTransaction",
	}
...
func _MsgService_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.evm.v1alpha1.MsgService/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _MsgService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gridiron.evm.v1alpha1.MsgService",
	...
	Metadata: "gridiron/evm/v1alpha1/tx.proto",
}
