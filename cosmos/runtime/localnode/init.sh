...
if [[ $overwrite == "y" || $overwrite == "Y" ]]; then
	...
	./bin/grid genesis add-genesis-account did:fury:1yrene6g2zwjttemf0c65fscg8w8c55w5vhc9hd 69000000000000000000000000afury --keyring-backend $KEYRING --home "$HOMEDIR"
