module github.com/furychain/gridiron/cosmos
...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/furychain/gridiron-geth v0.0.0-geth
...
replace (
        // Required for stateful precompiles and supporting the Ethereum JSON-RPC API.
	pkg.berachain.dev/polaris/contracts => github.com/furychain/gridiron/contracts v0.0.0-ctrc
        pkg.berachain.dev/polaris/eth => github.com/furychain/gridiron/eth v0.0.0-eth 
        pkg.berachain.dev/polaris/lib => github.com/furychain/gridiron/lib v0.0.0-lib 
)
